...
class TestVarasto(unittest.TestCase):
    ...
    def test_alkusaldo_oikea_maara(self):
        self.assertEqual(self.varasto.saldo, 0)

    def test_ylimaarainen(self):
        self.assertEqual(self.varasto_3.saldo, 5)

    def test_miinuksen_lisaaminen(self):
        self.varasto.lisaa_varastoon(-1)
        self.assertEqual(self.varasto.saldo, 0)
    
    def test_otetaan_huonosti_varastosta(self):
    ...
    def test_varaston_tilavuus_virhe(self):
